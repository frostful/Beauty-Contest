...
export function LegalShell({kicker,title,intro,children}:{kicker:string;title:string;intro:string;children:ReactNode}){
  ...
  return <main className="legal-page">
    ...
    <header className="legal-header"><Link className="legal-brand" href="/"><img src="/king-diamond.svg" alt=""/><span>MEDIAN</span></Link><nav aria-label="Legal navigation"><Link href="/">GAME</Link><Link className={privacyActive?"active":""} href="/privacy">PRIVACY</Link><Link className={termsActive?"active":""} href="/terms">TERMS</Link></nav></header>
